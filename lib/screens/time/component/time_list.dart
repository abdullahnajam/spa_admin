            ...
            builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              if (snapshot.data!.size==0){
                return Container(
                  ...
                  alignment: Alignment.center,
                  child: Text("No time slots are added"),
                );
              }
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  ...
  return DataRow(
    ...
    DataCell(Text(model.max.toString())),
        DataCell(Text(model.serviceName.toString())),
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('timeslots').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => TimeScreen())));
                  },
                )..show();
              },
