            ...
            builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              if (snapshot.data!.size==0){
                return Container(
                  ...
                  alignment: Alignment.center,
                  child: Text("No coupons are added"),
                );
              }
...
updateCoupon(CouponModel model,BuildContext context) async{
...
DateTime? end;
String? _serviceId;
Future<void> _showEditCoupon(CouponModel model,BuildContext context) async {
  String imageUrl="";
  ...
  String? discountType=model.discountType;
                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text("Edit Coupon",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: secondaryColor),),
                          ),
                        ),
                        Align(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              CouponModel newModel=new CouponModel(
                                  model.id,
                                  nameController.text,
                                  imageUrl==""?model.image:imageUrl,
                                  serviceController.text,
                                  _serviceId==null?model.serviceId:_serviceId!,
                              ...
                              updateCoupon(newModel,context);
                            },
                            child: Container(
                              height: 50,
                              color: secondaryColor,
                              alignment: Alignment.center,
                              child: Text("Update Coupon",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                            ),
                          )
                        ],
                      ),
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = CouponModel.fromSnapshot(data);
  return DataRow(
      cells: [
    DataCell(Text(model.name)),
    DataCell(Text(model.serviceName)),
        DataCell(model.discountType=="Amount"?Text(model.discount):Text("${model.discount}%")),
