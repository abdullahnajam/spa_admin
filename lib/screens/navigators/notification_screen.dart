...
import 'package:spa_admin_panel/screens/booking/booking.dart';
import 'package:spa_admin_panel/screens/branch/branches.dart';
import 'package:spa_admin_panel/screens/notifications/notifications.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: Notifications(_scaffoldKey),
            ),
          ],
        ),
      ),
